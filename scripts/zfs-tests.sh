...
# testdb[] is generated by scripts/make-testdb.sh
#
# It contains a database of test group run times in seconds.  Is used by
# split_tags() to divide up tests evenly (by total completion time) when
# called by the CI.  It will periodically need to be updated as new
# tests are added, but everything will still work even if a test is not in
# the database.
declare -A testdb=(["zpool_import"]=1983 ["redundancy"]=1437 ["mmp"]=1412
["pool_checkpoint"]=944 ["events"]=906 ["raidz"]=827 ["rsend"]=782
["zpool_scrub"]=757 ["bclone"]=708 ["slog"]=687 ["direct"]=641
["replacement"]=589 ["l2arc"]=575 ["zpool_create"]=444 ["removal"]=427
["zdb"]=405 ["fault"]=402 ["compression"]=342 ["checksum"]=298
["zpool_upgrade"]=274 ["redacted_send"]=274 ["no_space"]=272 ["zfs_get"]=271
["mmap"]=270 ["trim"]=269 ["zvol_misc"]=263 ["zpool_add"]=263 ["zfs_clone"]=250
["dedup"]=236 ["procfs"]=211 ["io"]=199 ["zpool_trim"]=182 ["btree"]=180
["zpool_expand"]=175 ["zfs_destroy"]=174 ["zfs_rename"]=152 ["zpool_wait"]=146
["alloc_class"]=141 ["zpool_initialize"]=139 ["mv_files"]=137
["zpool_prefetch"]=135 ["zpool_reopen"]=131 ["zvol_stress"]=125 ["cache"]=124
["block_cloning"]=121 ["delegate"]=118 ["zfs_receive"]=115 ["scan"]=113
["zfs_unmount"]=106 ["pyzfs"]=106 ["zfs_send"]=98 ["inheritance"]=91
["zpool_replace"]=88 ["gang_blocks"]=82 ["zfs_mount"]=76 ["zhack"]=75
["zpool_offline"]=65 ["zfs_share"]=65 ["zfs_set"]=65 ["large_dnode"]=61
["zfs_list"]=60 ["quota"]=60 ["inuse"]=60 ["zfs_rollback"]=59 ["deadman"]=58
["history"]=57 ["cp_files"]=57 ["atime"]=52 ["zpool_export"]=50
["zpool_resilver"]=49 ["zfs_create"]=49 ["ctime"]=48 ["zpool_status"]=47
["zfs_snapshot"]=47 ["zpool_split"]=46 ["vdev_zaps"]=45 ["refreserv"]=45
["mount"]=45 ["zfs_upgrade"]=44 ["zpool_events"]=43 ["nopwrite"]=41
["largest_pool"]=39 ["write_dirs"]=38 ["zstream"]=31 ["zfs"]=31 ["snapdir"]=31
["longname"]=31 ["zfs_set"]=30 ["zap_shrink"]=30 ["pool_names"]=29
["zpool_iostat"]=28 ["zpool_get"]=27 ["zfs_copies"]=27 ["userquota"]=27
["casenorm"]=27 ["misc"]=26 ["refquota"]=24 ["zpool_status"]=23 ["pam"]=23
["cachefile"]=23 ["upgrade"]=22 ["synctask_core"]=21 ["link_count"]=18
["limits"]=18 ["zfs_bookmark"]=17 ["async_destroy"]=17 ["zfs_rewrite"]=16
["reservation"]=16 ["luks"]=16 ["failmode"]=16 ["zpool_sync"]=15
["snapused"]=15 ["scrub_mirror"]=15 ["online_offline"]=15 ["zpool_clear"]=13
["zfs_diff"]=13 ["snapshot"]=12 ["send_xdr_encoding"]=12 ["log_spacemap"]=11
["bootfs"]=11 ["zpool_condense"]=10 ["truncate"]=10 ["rename_dirs"]=10
["grow"]=10 ["fadvise"]=10 ["zpool_set"]=9 ["clean_mirror"]=8
["zpool_iostat"]=7 ["user_namespace"]=7 ["syncfs"]=7 ["projectquota"]=7
["zpool_online"]=6 ["zfs_property"]=6 ["zfs_load-key"]=6 ["zfs_inherit"]=6
["xattr"]=6 ["zinject"]=5 ["zvol_swap"]=4 ["zpool_attach"]=4 ["zoned_uid"]=3
["zfs_wait"]=3 ["zfs_change-key"]=3 ["suid"]=3 ["sparse"]=3 ["fallocate"]=3
["cache"]=3 ["zpool_remove"]=2 ["zpool_labelclear"]=2 ["zpool_destroy"]=2
["zpool"]=2 ["zfs_unload-key"]=2 ["zfs_ids_to_path"]=2 ["off"]=2
["migration"]=2 ["zvol_ENOSPC"]=1 ["zpool_history"]=1 ["zfs_unshare"]=1
["zfs_promote"]=1 ["poolversion"]=1 ["device_access"]=1 ["zvol_cli"]=0
["zpool_wait"]=0 ["zpool_set"]=0 ["zpool_reguid"]=0 ["zpool_list"]=0
["zpool_influxdb"]=0 ["zpool_detach"]=0 ["zpool"]=0 ["zpool"]=0 ["zfs_sysfs"]=0
["zfs_reservation"]=0 ["zfs_program"]=0 ["zfs_list"]=0 ["zfs"]=0 ["zfs"]=0
["vdev_disk"]=0 ["unlink"]=0 ["tmpfile"]=0 ["stat"]=0 ["simd"]=0 ["rootpool"]=0
["renameat2"]=0 ["posix-sa"]=0 ["posix"]=0 ["posix"]=0 ["nestedfs"]=0
["lua_core"]=0 ["libzfs"]=0 ["lease"]=0 ["large_files"]=0 ["json"]=0
["idmap_mount"]=0 ["hkdf"]=0 ["exec"]=0 ["dos_attributes"]=0 ["devices"]=0
["crypto"]=0 ["crtime"]=0 ["chattr"]=0 ["arc"]=0 ["append"]=0)
...
# test tags".  The portion of tests is determined by estimated total test run
# time, not total test count.  For example, the tests in "1/2" should have
# about the same total run time run as "2/2".
#
...
split_tags() {
	...
	while read -r key val ; do
		...
		#echo "Putting $key into $min_index, ${total_time[$min_index]}"

		# Put the test into the bucket
		tests[min_index]=${tests[$min_index]}" "$key
		total_time[min_index]=$((total_time[min_index] + this_testdb[$key]))
