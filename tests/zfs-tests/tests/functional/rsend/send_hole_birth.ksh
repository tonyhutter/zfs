...
log_must randomdd of=/$sendfs/file1 bs=4k count=11264 seek=1152
log_must zfs snapshot $sendfs@snap1

log_must truncate -s 4M /$sendfs/file1
log_must randomdd of=/$sendfs/file1 bs=4k count=152 seek=384 \
    conv=notrunc
log_must randomdd of=/$sendfs/file1 bs=4k count=10 seek=1408 \
    conv=notrunc
...
log_must randomdd of=/$sendfs/file1 bs=128k count=1 seek=1
log_must zfs snapshot $sendfs@snap1

log_must randomdd of=/$sendfs/file1 bs=128k count=1
log_must randomdd of=/$sendfs/file1 bs=128k count=1 seek=3
log_must zfs snapshot $sendfs@snap2
...
log_must randomdd of=/$sendfs/file1 bs=512 count=128k conv=notrunc
log_must zfs snapshot $sendfs@snap1

log_must truncate -s 10M /$sendfs/file1
log_must randomdd of=/$sendfs/file1 bs=512 count=1 seek=96k \
    conv=notrunc
log_must zfs snapshot $sendfs@snap2
