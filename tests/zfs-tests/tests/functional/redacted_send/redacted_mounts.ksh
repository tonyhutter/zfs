...
log_must dd if=$RANDPIPE of=$clone_mnt/contents2 bs=512 count=1 conv=notrunc
log_must rm $clone_mnt/dir1/contents1
log_must rm -rf $clone_mnt/dir1/dir2
log_must dd if=$RANDPIPE of=$clone_mnt/dir1/contents2 bs=512 count=1 \
    conv=notrunc
log_must dd if=$RANDPIPE of=$clone_mnt/dir1/empty bs=512 count=1
...
log_must dd if=$RANDPIPE of=$send_mnt/dir1/contents1 bs=512 count=2
