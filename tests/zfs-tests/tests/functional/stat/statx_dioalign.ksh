...
log_must randomdd of=$TESTFILE bs=64k count=1
log_must zpool sync
...
log_must zfs set recordsize=128K $TESTDS
log_must randomdd of=$TESTFILE bs=192K count=1
log_must zpool sync
...
log_must randomdd of=$TESTFILE bs=16384 count=16 oflag=direct
...
log_must zpool sync
assert_dioalign $TESTFILE $PAGE_SIZE 16384
log_mustnot randomdd of=$TESTFILE bs=1024 count=256 oflag=direct
...
log_must zpool sync
assert_dioalign $TESTFILE $PAGE_SIZE 16384
log_must randomdd of=$TESTFILE bs=1024 count=256 oflag=direct
